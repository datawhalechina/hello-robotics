...
"""OmniGraph-based IMU ROS2 publisher."""
...
def publish_imu(imu, approx_freq, topic):
    """Publish IMU data via ROS2 OmniGraph."""
    ...
    og.Controller.edit(
        ...
        },
        {
            og.Controller.Keys.CREATE_NODES: [
                ...
                ("RosPublishImu", "isaacsim.ros2.bridge.ROS2PublishImu"),
            ...
            og.Controller.Keys.CONNECT: [
                ...
                ("RosContext.outputs:context", "RosPublishImu.inputs:context"),
                ("IsaacReadIMUNode.outputs:angVel", "RosPublishImu.inputs:angularVelocity"),
                ("IsaacReadIMUNode.outputs:linAcc", "RosPublishImu.inputs:linearAcceleration"),
                ("IsaacReadIMUNode.outputs:orientation", "RosPublishImu.inputs:orientation"),
                ("IsaacReadIMUNode.outputs:execOut", "RosPublishImu.inputs:execIn"),
                ("OnPlaybackTick.outputs:time", "RosPublishImu.inputs:timeStamp"),
            ],
        },
    )
    set_target_prims(
