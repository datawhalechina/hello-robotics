...
"""OmniGraph-based lidar ROS2 publishers."""
...
def publish_lidar_pointcloud(camera, freq, topic=""):
    """Publish lidar point cloud via ROS2 using RtxLidar writer."""
...
def publish_lidar_scan(camera, freq, topic=""):
    """Publish lidar laser scan via ROS2 using RtxLidar writer."""
    render_product = camera._render_product_path
    step_size = int(60 / freq)
