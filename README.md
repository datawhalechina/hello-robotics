...
| [第九章 感知控制综合实践：视觉感知控制](./docs/chapter9/第九章%20感知控制综合实践：视觉感知控制.md)                         | 融合目标检测分割点云与GraspGenX抓取生成，实现机械臂视觉引导抓取与放置              | ✅    |
...
| 第十二章 移动操作综合实践：全场景自主导航操作                  | 结合建图与导航算法，以及操作控制，实现全场景的移动操作任务              | 🚧    |
...
| [第十五章 经验驱动的VLA强化学习微调](./docs/chapter15/第十五章%20经验驱动的VLA强化学习微调.md)       | 	参考evo-rl（pi0.6*改进），通过真实机器人经验与自动纠正进行强化学习微调      | ✅    |
| [第十六章 潜在动作世界模型](./docs/chapter16/第十六章%20潜在动作世界模型.md)       | 讲解Motus世界模型，统一视觉理解、未来预测与机器人动作生成   | ✅    |
| 第十七章 决策闭环综合实践：听指令做任务                    | 打通感知、大模型决策与底层控制，实现感知理解并执行的完整闭环                 | 🚧    |
| <strong>第六部分 走向前沿落地：前沿具身算法部署实践</strong>                                   |                                               |      |
| [前沿算法1 ACoT-VLA 视觉语言动作模型部署](./sota_algorithm/g2/前沿算法1-acotvla/docs/ACoT-VLA%20视觉语言动作模型部署.md) | 通过显式粗动作参考与隐式动作先验，引导 G2 生成精细动作并完成三色物块入盒任务 | ✅ |
| 第十九章 前沿算法部署2                    |                  | 🚧    |
